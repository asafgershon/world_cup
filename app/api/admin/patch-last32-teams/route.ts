...
const T: Record<string, TeamData> = {
  ...
  Spain:          { id: 760, name: 'Spain',          shortName: 'Spain',        tla: 'ESP', crest: 'https://crests.football-data.org/760.svg' },
  Austria:        { id: 816, name: 'Austria',        shortName: 'Austria',      tla: 'AUT', crest: 'https://crests.football-data.org/816.svg' },
  ...
  Switzerland:    { id: 788, name: 'Switzerland',    shortName: 'Switzerland',  tla: 'SUI', crest: 'https://crests.football-data.org/788.svg' },
  Algeria:        { id: 778, name: 'Algeria',        shortName: 'Algeria',      tla: 'ALG', crest: 'https://crests.football-data.org/algeria.svg' },
...
const LAST32_FIXTURES: Record<number, [string, string]> = {
  ...
  537420: ['Spain',         'Austria'],
  537419: ['Portugal',      'Croatia'],
  537429: ['Switzerland',   'Algeria'],
